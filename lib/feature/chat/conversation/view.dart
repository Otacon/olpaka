  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ConversationViewModel>.reactive(
      ...
      builder: (context, viewModel, child) {
        ...
        return switch (state) {
          ConversationStateLoading() => const Loading(),
          ConversationStateContent() => _content(
              context,
          ...
          ConversationStateError() => EmptyScreen(
              header: state.title,
              body: state.message,
      ...
      content = ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return switch (message) {
            ConversationMessageUser() => _chatMessage(
                context,
                sender: S.current.chat_user_name,
                text: message.message,
              ),
            ConversationMessageError() => _chatError(
                context,
                text: message.message,
              ),
            ConversationMessageAssistant() => _chatMessage(
                context,
